        ...
        <div class="border-bottom pb-2 mb-2">
          <div class="container">
            <div class="row align-items-center">
              <div class="col-lg-3">
                <form action="#" class="subscribe mb-2 mb-lg-0">
              ...
              <div class="col-lg-6 text-lg-center">
                <ul class="list-unstyled nav-links nav-left mb-2 mb-lg-0">
                  <li><a href="#">Home</a></li>
                  <li><a href="#">Predict Disease</a></li>
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-4 text-lg-center site-logo order-1 order-lg-2 mb-3 mb-lg-0">
              <a href="#" class="m-0 p-0">We 3 care</a>
            </div>

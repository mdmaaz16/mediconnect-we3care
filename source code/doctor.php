...
.btn-primary{
  ...
  <div class="col-md-4" style="max-width:25%;margin-top: -2%; position: fixed;">
    <div class="list-group" id="list-tab" role="tablist">
      <a class="list-group-item list-group-item-action active" href="#list-dash" role="tab" aria-controls="home" data-toggle="list"  style="text-align: center;">Dashboard</a>
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  <?php 
                    ...
                    $query = "select patient_ids,firstname,lastname,gender,phone_num,time,date,app_id from bookappointment where doctor_ids='$did' and isprescribed='No'";
                    ...
                    while ($row = mysqli_fetch_array($result)){
                      ...
                      <td><?php echo $row['patient_ids'];?></td>
                        ...
                        <?php 
                         ?>
                       <a class="btn btn-primary" href="prescribe.php?id=<?php echo $row['app_id'];?>">PRESCRIBE</a>
                        <?php  ?>
                                                </td>
                      </tr></a>
                    <?php } ?>
              ...
              <table class="table table-hover">
                <tbody>
                  <form method="post">
                      ...
                      <tr>
                        <td></td>
                        <td><input type="submit" name="submit" class="btn-primary btn b1" onclick="alert('Message sent Successfully')"></td> 
                      </tr>
                  </form>
